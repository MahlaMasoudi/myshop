...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->tinyInteger('delivery_status')->default(0)->comment('0=>ersalNashode,1=>darhalErsal, 2=>ErsalShode,defult=>tahvailShode');
            ...
            $table->tinyInteger('order_status')->default(0)->comment('1=>darentezarTaeed,2=>taeedNashode,3=>taeedshode,4=>batelshode,5=>marjoShode ,default=>barrasiNashode');
            $table->timestamps();
            $table->softDeletes();
        });
    }
