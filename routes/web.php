...
use App\Http\Controllers\Customer\Market\ProductController;
...
use App\Http\Controllers\Admin\Market\ProductController as MarketProductController;
...
Route::prefix('admin')->group(function () {
    ...
    Route::prefix('market')->group(function () {
        ...
        Route::prefix('barnd')->group(function () {
        ...
        Route::prefix('product')->group(function () {
            ...
            Route::get('/', [MarketProductController::class, 'index'])->name('admin.market.product.index');
            Route::get('/create', [MarketProductController::class, 'create'])->name('admin.market.product.create');
            Route::post('/store', [MarketProductController::class, 'store'])->name('admin.market.product.store');
            Route::get('/edit/{product}', [MarketProductController::class, 'edit'])->name('admin.market.product.edit');
            Route::put('/update/{product}', [MarketProductController::class, 'update'])->name('admin.market.product.update');
            Route::delete('/destroy/{product}', [MarketProductController::class, 'destroy'])->name('admin.market.product.destroy');
...
Route::get('/product/{product:slug}', [ProductController::class, 'product'])->name('customer.market.product');
Route::post('/add-comment/prodcut/{product:slug}', [ProductController::class, 'addComment'])->name('customer.market.add-comment');

Route::get('/add-to-compare/prodcut/{product:slug}', [ProductController::class, 'addToCompare'])->name('customer.market.add-to-compare');
Route::get('/add-to-favorite/prodcut/{product:slug}', [ProductController::class, 'addToFavorite'])->name('customer.market.add-to-favorite');
Route::post('/add-rate/prodcut/{product:slug}', [ProductController::class, 'addRate'])->name('customer.market.add-rate');
